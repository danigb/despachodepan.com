!(function(e, t) {
  function n(e) {
    var t = (ht[e] = {});
    return (
      K.each(e.split(tt), function(e, n) {
        t[n] = !0;
      }),
      t
    );
      ...
      if (((r = e.getAttribute(i)), "string" == typeof r)) {
        try {
          r =
            "true" === r
              ? !0
              : "false" === r ? !1 : "null" === r ? null : +r + "" === r ? +r : gt.test(r) ? K.parseJSON(r) : r;
        } catch (o) {}
        K.data(e, n, r);
      } else r = t;
    }
    ...
    1 === t.nodeType &&
      ...
      "object" === n
        ? (t.parentNode && (t.outerHTML = e.outerHTML),
          K.support.html5Clone && e.innerHTML && !K.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
        : "input" === n && Vt.test(e.type)
        ...
        n.style &&
          ...
          t
            ? (!i[o] && "none" === n.style.display && (n.style.display = ""),
              "" === n.style.display && y(n) && (i[o] = K._data(n, "olddisplay", T(n.nodeName))))
            : ((r = nn(n, "display")), !i[o] && "none" !== r && K._data(n, "olddisplay", r)));
    for (o = 0; a > o; o++)
      (n = e[o]),
        n.style &&
          ((t && "none" !== n.style.display && "" !== n.style.display) || (n.style.display = t ? i[o] || "" : "none"));
    return e;
  }
  function b(e, t, n) {
    var r = cn.exec(t);
  ...
  function x(e, t, n, r) {
    for (var i = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > i; i += 2)
      "margin" === n && (o += K.css(e, n + mn[i], !0)),
        r
          ? ("content" === n && (o -= parseFloat(nn(e, "padding" + mn[i])) || 0),
            "margin" !== n && (o -= parseFloat(nn(e, "border" + mn[i] + "Width")) || 0))
          : ((o += parseFloat(nn(e, "padding" + mn[i])) || 0),
            "padding" !== n && (o += parseFloat(nn(e, "border" + mn[i] + "Width")) || 0));
    return o;
  }
  function w(e, t, n) {
  ...
  function T(e) {
    if (dn[e]) return dn[e];
    var t = K("<" + e + ">").appendTo(P.body),
      n = t.css("display");
    return (
      t.remove(),
      ("none" === n || "" === n) &&
        ((rn = P.body.appendChild(rn || K.extend(P.createElement("iframe"), { frameBorder: 0, width: 0, height: 0 }))),
        (on && rn.createElement) ||
          ((on = (rn.contentWindow || rn.contentDocument).document),
          on.write("<!doctype html><html><body>"),
          on.close()),
        (t = on.body.appendChild(on.createElement(e))),
        (n = nn(t, "display")),
        P.body.removeChild(rn)),
      (dn[e] = n),
      n
    );
  }
  function N(e, t, n, r) {
    ...
    if (K.isArray(t))
      K.each(t, function(t, i) {
        n || xn.test(e) ? r(e, i) : N(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r);
      });
  ...
  function k(e, n, r, i, o, a) {
    ...
    for (var s, u = e[o], l = 0, c = u ? u.length : 0, f = e === Mn; c > l && (f || !s); l++)
      (s = u[l](n, r, i)),
  ...
  function H(e, t, n) {
    var r,
      ...
      l = u.props;
    for (_(l, u.opts.specialEasing); o > i; i++) if ((r = Kn[i].call(u, e, l, u.opts))) return r;
    return (
      $(u, l),
      K.isFunction(u.opts.start) && u.opts.start.call(e, u),
      K.fx.timer(K.extend(s, { anim: u, queue: u.opts.queue, elem: e })),
  ...
  function F(e, t, n) {
    ...
    if ((a = h.length))
      for (
        ...
        (i = h[r]),
          (u = f.createTween(i, g ? s[i] : 0)),
          (d[i] = s[i] || K.style(e, i)),
          i in s || ((s[i] = u.start), g && ((u.end = u.start), (u.start = "width" === i || "height" === i ? 1 : 0)));
  }
  ...
  var B,
    ...
    pt = function() {
      P.addEventListener
        ? (P.removeEventListener("DOMContentLoaded", pt, !1), K.ready())
        : "complete" === P.readyState && (P.detachEvent("onreadystatechange", pt), K.ready());
    },
    dt = {};
  (K.fn = K.prototype = {
    constructor: K,
    init: function(e, n, r) {
      ...
      if ("string" == typeof e) {
        if (
          ((i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : rt.exec(e)),
          i && (i[1] || !n))
        ) {
          if (i[1])
            return (
              (n = n instanceof K ? n[0] : n),
              (a = n && n.nodeType ? n.ownerDocument || n : P),
      ...
      return K.isFunction(e)
        ? r.ready(e)
        : (e.selector !== t && ((this.selector = e.selector), (this.context = e.context)), K.makeArray(e, this));
    },
    selector: "",
    jquery: "1.8.0",
    length: 0,
            ...
            (r = s[n]),
              ...
              s !== i &&
                (c && i && (K.isPlainObject(i) || (o = K.isArray(i)))
                  ? (o ? ((o = !1), (a = r && K.isArray(r) ? r : [])) : (a = r && K.isPlainObject(r) ? r : {}),
                    (s[n] = K.extend(c, a, i)))
                  : i !== t && (s[n] = i));
      return s;
    }),
    K.extend({
      ...
      ready: function(e) {
        if (e === !0 ? !--K.readyWait : !K.isReady) {
          if (!P.body) return setTimeout(K.ready, 1);
          (K.isReady = !0),
            (e !== !0 && --K.readyWait > 0) ||
              (I.resolveWith(P, [K]), K.fn.trigger && K(P).trigger("ready").off("ready"));
        }
      },
          ...
          ? ("boolean" == typeof t && ((n = t), (t = 0)),
            ...
            (r = it.exec(e))
              ...
              : ((r = K.buildFragment([e], t, n ? null : [])),
                K.merge([], (r.cacheable ? K.clone(r.fragment) : r.fragment).childNodes)))
          : null;
      },
      parseJSON: function(t) {
        return t && "string" == typeof t
          ? ((t = K.trim(t)),
            e.JSON && e.JSON.parse
              ? e.JSON.parse(t)
              : ot.test(t.replace(st, "@").replace(ut, "]").replace(at, ""))
      ...
      parseXML: function(n) {
        ...
        return (
          (!r || !r.documentElement || r.getElementsByTagName("parsererror").length) && K.error("Invalid XML: " + n), r
        );
      },
      noop: function() {},
      ...
      makeArray: function(e, t) {
        ...
        return (
          null != e &&
            ((n = K.type(e)),
            null == e.length || "string" === n || "function" === n || "regexp" === n || K.isWindow(e)
              ? U.call(r, e)
              : K.merge(r, e)),
          r
        );
      ...
      map: function(e, n, r) {
        var i,
          ...
          l =
            e instanceof K ||
            (u !== t && "number" == typeof u && ((u > 0 && e[0] && e[u - 1]) || 0 === u || K.isArray(e)));
        if (l) for (; u > s; s++) (i = n(e[s], s, r)), null != i && (a[a.length] = i);
    ...
    (K.ready.promise = function(t) {
      if (!I)
        if (((I = K.Deferred()), "complete" === P.readyState || ("loading" !== P.readyState && P.addEventListener)))
          setTimeout(K.ready, 1);
        else if (P.addEventListener)
          P.addEventListener("DOMContentLoaded", pt, !1), e.addEventListener("load", K.ready, !1);
        else {
          P.attachEvent("onreadystatechange", pt), e.attachEvent("onload", K.ready);
          var n = !1;
          try {
  ...
  (K.Callbacks = function(e) {
          ...
          if (l) {
            ...
            !(function n(t) {
              K.each(t, function(t, r) {
                !K.isFunction(r) || (e.unique && p.has(r)) ? r && r.length && n(r) : l.push(r);
              });
            })(arguments),
              o ? (s = l.length) : r && ((a = t), f(r));
          }
          return this;
        },
        remove: function() {
    ...
    (K.support = (function() {
      ...
      (i = P.createElement("select")),
        (o = i.appendChild(P.createElement("option"))),
      ...
      if (
        ...
        for (l in { submit: !0, change: !0, focusin: !0 })
          (u = "on" + l),
            (c = u in p),
            c || (p.setAttribute(u, "return;"), (c = "function" == typeof p[u])),
            (t[l + "Bubbles"] = c);
      return (
        K(function() {
          var n,
          ...
          s &&
            ...
            e.getComputedStyle &&
              ((t.pixelPosition = "1%" !== (e.getComputedStyle(r, null) || {}).top),
    ...
    data: function(e, n, r, i) {
      if (K.acceptData(e)) {
        ...
        if ((f && c[f] && (i || c[f].data)) || !u || r !== t)
          return (
            f || (l ? (e[s] = f = K.deletedIds.pop() || ++K.uuid) : (f = s)),
            c[f] || ((c[f] = {}), l || (c[f].toJSON = K.noop)),
            ("object" == typeof n || "function" == typeof n) &&
              (i ? (c[f] = K.extend(c[f], n)) : (c[f].data = K.extend(c[f].data, n))),
            (o = c[f]),
            i || (o.data || (o.data = {}), (o = o.data)),
            r !== t && (o[K.camelCase(n)] = r),
            u ? ((a = o[n]), null == a && (a = o[K.camelCase(n)])) : (a = o),
            a
          );
      }
    },
    removeData: function(e, t, n) {
      if (K.acceptData(e)) {
        ...
        if (u[l]) {
          ...
          (n || (delete u[l].data, i(u[l]))) &&
            (s ? K.cleanData([e], !0) : K.support.deleteExpando || u != u.window ? delete u[l] : (u[l] = null));
        }
      }
    },
      ...
      data: function(e, n) {
        ...
        if (e === t) {
          if (this.length && ((f = K.data(l)), 1 === l.nodeType && !K._data(l, "parsedAttrs"))) {
            for (a = l.attributes, u = a.length; u > c; c++)
              (s = a[c].name), 0 === s.indexOf("data-") && ((s = K.camelCase(s.substring(5))), r(l, s, f[s]));
    ...
    K.extend({
      ...
      dequeue: function(e, t) {
        ...
        "inprogress" === r && (r = n.shift()),
          r && ("fx" === t && n.unshift("inprogress"), delete i.stop, r.call(e, o, i)),
    ...
    K.fn.extend({
      ...
      promise: function(e, n) {
        ...
        for ("string" != typeof e && ((n = e), (e = t)), e = e || "fx"; s--; )
          (r = K._data(a[s], e + "queueHooks")) && r.empty && (i++, r.empty.add(u));
  ...
  K.fn.extend({
    ...
    toggleClass: function(e, t) {
      ...
      return this.each(
        K.isFunction(e)
          ...
          : function() {
              if ("string" === n)
                for (var i, o = 0, a = K(this), s = t, u = e.split(tt); (i = u[o++]); )
        ...
        if (o)
          return (
            ...
            n && "get" in n && (r = n.get(o, "value")) !== t
              ? r
              : ((r = o.value), "string" == typeof r ? r.replace(wt, "") : null == r ? "" : r)
          );
      }
    },
  }),
          ...
          get: function(e) {
            ...
            for (n = u ? o : 0, r = u ? o + 1 : s.length; r > n; n++)
              if (
                ...
                !(
                  !i.selected ||
                  (K.support.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) ||
        ...
        if (e && 3 !== u && 8 !== u && 2 !== u)
          return i && K.isFunction(K.fn[n])
            ...
            : "undefined" == typeof e.getAttribute
              ? K.prop(e, n, r)
              : ((s = 1 !== u || !K.isXMLDoc(e)),
                s && ((n = n.toLowerCase()), (a = K.attrHooks[n] || (kt.test(n) ? vt : yt))),
                r !== t
                  ? null === r
                    ? void K.removeAttr(e, n)
                    : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r), r)
        ...
        tabIndex: {
          get: function(e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : Nt.test(e.nodeName) || (Ct.test(e.nodeName) && e.href) ? 0 : t;
          },
        },
      },
    }),
    (vt = {
      get: function(e, n) {
        var r,
          i = K.prop(e, n);
        return i === !0 || ("boolean" != typeof i && (r = e.getAttributeNode(n)) && r.nodeValue !== !1)
          ? n.toLowerCase()
          : t;
      },
      set: function(e, t, n) {
        ...
        return (
          t === !1
            ? K.removeAttr(e, n)
            : ((r = K.propFix[n] || n), r in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())),
          n
        );
      },
    }),
    Et ||
      ((bt = { name: !0, id: !0, coords: !0 }),
  ...
  (K.event = {
      ...
      if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = K._data(e))) {
        for (
          r.handler && ((h = r), (r = h.handler), (o = h.selector)),
            ...
            s = a.handle,
            s ||
              ((a.handle = s = function(e) {
                return "undefined" == typeof K || (e && K.event.triggered === e.type)
                  ? t
          ...
          (c = At.exec(n[l]) || []),
            ...
            (m = K.event.special[f] || {}),
            (d = K.extend(
              { type: f, origType: c[1], data: i, handler: r, guid: r.guid, selector: o, namespace: p.join(".") },
              h,
            )),
            (g = u[f]),
            g ||
              ...
              (m.setup && m.setup.call(e, i, p, s) !== !1) ||
                (e.addEventListener ? e.addEventListener(f, s, !1) : e.attachEvent && e.attachEvent("on" + f, s))),
    ...
    remove: function(e, t, n, r, i) {
      ...
      if (m && (p = m.events)) {
        for (t = K.trim(Ht(t || "")).split(" "), o = 0; o < t.length; o++)
            ...
            for (
              ...
              (g = h[f]),
                !(
                  ...
                  (h.splice(f--, 1), g.selector && h.delegateCount--, !d.remove || !d.remove.call(e, g))
                );
            0 === h.length &&
              c !== h.length &&
              ((!d.teardown || d.teardown.call(e, l, m.handle) === !1) && K.removeEvent(e, s, m.handle), delete p[s]);
    ...
    trigger: function(n, r, i, o) {
      if (!i || (3 !== i.nodeType && 8 !== i.nodeType)) {
        var a,
          ...
          m = n.type || n,
          y = [];
        if ($t.test(m + K.event.triggered)) return;
        if (
          ...
          return;
        if (
          ((n = "object" == typeof n ? (n[K.expando] ? n : new K.Event(m, n)) : new K.Event(m)),
          (n.type = m),
          (n.isTrigger = !0),
          (n.exclusive = s),
          (n.namespace = y.join(".")),
        ...
        if (((h = [[i, p.bindType || m]]), !o && !p.noBubble && !K.isWindow(i))) {
          for (g = p.delegateType || m, l = $t.test(g + m) ? i : i.parentNode, c = i; l; l = l.parentNode)
            h.push([l, g]), (c = l);
          c === (i.ownerDocument || P) && h.push([c.defaultView || c.parentWindow || e, g]);
        }
        for (u = 0; u < h.length && !n.isPropagationStopped(); u++)
          (l = h[u][0]),
            (n.type = h[u][1]),
            (d = (K._data(l, "events") || {})[n.type] && K._data(l, "handle")),
            d && d.apply(l, r),
            (d = f && l[f]),
            d && K.acceptData(l) && d.apply(l, r) === !1 && n.preventDefault();
        return (
          (n.type = m),
          !(
            o ||
      ...
      if (((g[0] = n), (n.delegateTarget = this), !y.preDispatch || y.preDispatch.call(this, n) !== !1)) {
        if (h && (!n.button || "click" !== n.type))
          for (a = K(this), a.context = this, o = n.target; o != this; o = o.parentNode || this)
            if (o.disabled !== !0 || "click" !== n.type) {
              for (u = {}, c = [], a[0] = o, r = 0; h > r; r++)
                (f = d[r]), (p = f.selector), u[p] === t && (u[p] = a.is(p)), u[p] && c.push(f);
        ...
        for (
          ...
          for (
            ...
            (f = l.matches[i]),
              (m || (!n.namespace && !f.namespace) || (n.namespace_re && n.namespace_re.test(f.namespace))) &&
                ((n.data = f.data),
                (n.handleObj = f),
                (s = ((K.event.special[f.origType] || {}).handle || f.handler).apply(l.elem, g)),
    ...
    fix: function(e) {
      ...
      return (
        e.target || (e.target = r.srcElement || P),
    ...
    (K.removeEvent = P.removeEventListener
      ? function(e, t, n) {
        ...
        ? (e && e.type
            ? ((this.originalEvent = e),
              ...
              (this.isDefaultPrevented =
                e.defaultPrevented || e.returnValue === !1 || (e.getPreventDefault && e.getPreventDefault()) ? a : o))
            : (this.type = e),
          t && K.extend(this, t),
    ...
    K.support.submitBubbles ||
      (K.event.special.submit = {
        setup: function() {
          return K.nodeName(this, "form")
            ? !1
            : void K.event.add(this, "click._submit keypress._submit", function(e) {
                var n = e.target,
    ...
    (function(e, t) {
      ...
      function i(e, i, o, a, s) {
        for (
          ...
          for (v.exec(""), e = s[m], f = [], c = 0, p = a; (u = v.exec(e)); )
            (g = v.lastIndex = u.index + u[0].length),
              g > c &&
                ((h = e.slice(c, u.index)),
                (c = g),
                (d = [i]),
                _.test(h) && (p && (d = p), (p = a)),
                (l = I.test(h)) && (h = h.slice(0, -5).replace(_, "$&*")),
                u.length > 1 && u[0].replace(b, x),
                (p = r(h, u[1], u[2], d, p, l)));
          p
            ? ((f = f.concat(p)),
              (h = e.slice(c)) && ")" !== h
                ? _.test(h) ? n(h, f, o, a) : ot(h, i, o, a ? a.concat(p) : p)
                : T.apply(o, f))
            : ot(e, i, o, a);
        }
      ...
      function o(e, t, n) {
        for (
          ...
          for (a.push((r = [])), d && (i = " " + i); i; ) {
            (l = !1),
              (u = _.exec(i)) &&
                ((i = i.slice(u[0].length)), (l = r.push({ part: u.pop().replace(H, " "), captures: u })));
            for (o in p)
              (u = z[o].exec(i)) &&
                (!f[o] || (u = f[o](u, t, n))) &&
                ((i = i.slice(u.shift().length)), (l = r.push({ part: o, captures: u })));
            if (!l) break;
          }
      ...
      function u(e, t, n) {
        for (var r, i, o = 0; (r = e[o]); o++)
          at.relative[r.part]
            ? (i = a(i, at.relative[r.part], t))
            : (r.captures.push(t, n), (i = s(i, at.filter[r.part].apply(null, r.captures))));
        return i;
      }
      function l(e) {
        return function(t, n) {
        ...
        it = Z(function(e) {
          return (
            ...
            e.getElementsByClassName && 0 !== e.getElementsByClassName("e").length
              ? ((e.lastChild.className = "e"), 1 !== e.getElementsByClassName("e").length)
              : !1
          );
        }),
        ot = function(e, t, n, r) {
          ...
          if (((a = ut(t)), !a && !r && (i = q.exec(e))))
            if ((s = i[1])) {
              ...
              } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(s)) && lt(t, o) && o.id === s)
                return n.push(o), n;
            } else {
              if (i[2]) return T.apply(n, w.call(t.getElementsByTagName(e), 0)), n;
              if ((s = i[3]) && it && t.getElementsByClassName)
        ...
        at = (ot.selectors = {
            ...
            ID: h
              ...
              : function(e, n, r) {
                  if (typeof n.getElementById !== y && !r) {
                    ...
                    return i
                      ? i.id === e || (typeof i.getAttributeNode !== y && i.getAttributeNode("id").value === e)
                        ? [i]
                        : t
                      : [];
                  }
            ...
            PSEUDO: function(e) {
              ...
              return z.CHILD.test(e[0])
                ...
                : (n &&
                    (t = M.exec(n)) &&
                    t.pop() &&
                    ((e[0] = e[0].slice(0, t[0].length - n.length - 1)), (n = t[0].slice(0, -1))),
                  e.splice(2, 3, n || e[3]),
                  e);
            },
          },
          filter: {
            ...
            CLASS: function(e) {
              ...
              return (
                t ||
                  ((t = X[e] = new RegExp("(^|" + C + ")" + e + "(" + C + "|$)")),
                  U.push(e),
                  U.length > at.cacheLength && delete X[U.shift()]),
                function(e) {
      ...
      (at.setFilters.nth = at.setFilters.eq),
        (at.filters = at.pseudos),
        rt ||
          (at.attrHandle = {
            href: function(e) {
        ...
        tt &&
          (at.order.push("NAME"),
          (at.find.NAME = function(e, t) {
            return typeof t.getElementsByName !== y ? t.getElementsByName(e) : void 0;
          })),
        it &&
          (at.order.splice(1, 0, "CLASS"),
          (at.find.CLASS = function(e, t, n) {
      ...
      var ut = (ot.isXML = function(e) {
        ...
        lt = (ot.contains = m.compareDocumentPosition
          ? function(e, t) {
      ...
      (ot.attr = function(e, t) {
        ...
        m.compareDocumentPosition
          ...
          : ((p = function(e, t) {
              ...
              for (var l = 0; n > l && r > l; l++) if (i[l] !== o[l]) return d(i[l], o[l]);
              return l === n ? d(e, o[l], -1) : d(i[l], t, 1);
            }),
            (d = function(e, t, n) {
              if (e === t) return n;
        ...
        (ot.uniqueSort = function(e) {
          var t,
            n = 1;
          if (p && ((v = b), e.sort(p), v)) for (; (t = e[n]); n++) t === e[n - 1] && e.splice(n--, 1);
          return e;
        });
      var ft = (ot.compile = function(e, t, n) {
        ...
        return (
          ...
          (s.runs = s.dirruns = 0),
          J.push(e),
          J.length > at.cacheLength && delete Y[J.shift()],
          s
        );
      });
      ...
      var pt = function(e, t, n, r, o) {
        ...
        if (r) a = w.call(r, 0);
          ...
          for (
            g = ((y = B.exec(v[0])) && !y.index && t.parentNode) || t,
              m = v.pop(),
              d = m.split(":not")[0],
              u = 0,
              l = at.order.length;
            ...
            if (((h = at.order[u]), (y = z[h].exec(d)))) {
              if (((a = at.find[h]((y[1] || "").replace(R, ""), g, o)), null == a)) continue;
        ...
        if (e)
          for (
            s = ft(e, t, o),
              f = s.dirruns++,
              null == a && (a = at.find.TAG("*", (B.test(e) && t.parentNode) || t)),
              u = 0;
            (p = a[u]);
            u++
          )
          ...
          Z(function(e) {
            (e.innerHTML = "<select><option selected></option></select>"),
              e.querySelectorAll("[selected]").length ||
                i.push("\\[" + C + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
              e.querySelectorAll(":checked").length || i.push(":checked");
          }),
            Z(function(e) {
              (e.innerHTML = "<p test=''></p>"),
                e.querySelectorAll("[test^='']").length && i.push("[*^$]=" + C + "*(?:\"\"|'')"),
                (e.innerHTML = "<input type='hidden'>"),
                e.querySelectorAll(":enabled").length || i.push(":enabled", ":disabled");
            }),
            (i = i.length && new RegExp(i.join("|"))),
            (pt = function(e, r, o, a, s) {
              if (!(a || s || (i && i.test(e))))
                if (9 === r.nodeType)
                  try {
            ...
            a &&
              ...
              (o = new RegExp(o.join("|"))),
              (ot.matchesSelector = function(t, n) {
                if (((n = n.replace(r, "='$1']")), !(ut(t) || o.test(n) || (i && i.test(n)))))
                  try {
                    var s = a.call(t, n);
  ...
  K.fn.extend({
    ...
    is: function(e) {
      return (
        !!e &&
        ("string" == typeof e
          ? Ot.test(e) ? K(e, this.context).index(this[0]) >= 0 : K.filter(e, this).length > 0
          : this.filter(e).length > 0)
      );
    },
    closest: function(e, t) {
      for (
        var n, r = 0, i = this.length, o = [], a = Ot.test(e) || "string" != typeof e ? K(e, t || this.context) : 0;
        i > r;
        r++
      )
    ...
    index: function(e) {
      return e
        ? "string" == typeof e ? K.inArray(this[0], K(e)) : K.inArray(e.jquery ? e[0] : e, this)
      ...
      function(e, t) {
        K.fn[e] = function(n, r) {
          ...
          return (
            ...
            (i = this.length > 1 && !qt[e] ? K.unique(i) : i),
  ...
  (Zt.optgroup = Zt.option),
    ...
    K.fn.extend({
      text: function(e) {
        return K.access(
          ...
          function(e) {
            return e === t
              ? K.text(this)
              : this.empty().append(((this[0] && this[0].ownerDocument) || P).createTextNode(e));
          },
          null,
          e,
          arguments.length,
      ...
      remove: function(e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (!e || K.filter(e, [n]).length) &&
            (!t && 1 === n.nodeType && (K.cleanData(n.getElementsByTagName("*")), K.cleanData([n])),
          ...
          function(e) {
            ...
            if (
              !(
                "string" != typeof e ||
                Ut.test(e) ||
                (!K.support.htmlSerialize && Jt.test(e)) ||
                (!K.support.leadingWhitespace && Pt.test(e)) ||
                Zt[(Rt.exec(e) || ["", ""])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Wt, "<$1></$2>");
              try {
      ...
      replaceWith: function(e) {
        return s(this[0])
          ? this.length ? this.pushStack(K(K.isFunction(e) ? e() : e), "replaceWith", e) : this
          : K.isFunction(e)
      ...
      domManip: function(e, n, r) {
        ...
        var i,
          ...
          c = [],
          p = this.length;
        if (!K.support.checkClone && p > 1 && "string" == typeof l && Gt.test(l))
          return this.each(function() {
        ...
        if (this[0]) {
          if (
            ...
            for (n = n && K.nodeName(o, "tr"), s = i.cacheable || p - 1; p > u; u++)
              r.call(
                n && K.nodeName(this[u], "table") ? f(this[u], "tbody") : this[u],
                u === s ? a : K.clone(a, !0, !0),
              );
          (a = o = null),
            c.length &&
              K.each(c, function(e, t) {
                t.src
                  ? K.ajax
                    ? K.ajax({ url: t.src, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 })
                    : K.error("no ajax")
                  : K.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Kt, "")),
    ...
    (K.buildFragment = function(e, n, r) {
      ...
      return (
        ...
        "undefined" == typeof n.createDocumentFragment && (n = P),
        1 === e.length &&
          "string" == typeof s &&
          s.length < 512 &&
          n === P &&
          "<" === s.charAt(0) &&
          !Yt.test(s) &&
          (K.support.checkClone || !Gt.test(s)) &&
          (K.support.html5Clone || !Jt.test(s)) &&
    ...
    K.each(
      ...
      function(e, t) {
        K.fn[e] = function(n) {
          ...
          if ((null == u || (u && 11 === u.nodeType && 1 === u.childNodes.length)) && 1 === s)
    ...
    K.extend({
      clone: function(e, t, n) {
        var r, i, o, a;
        if (
          (K.support.html5Clone || K.isXMLDoc(e) || !Jt.test("<" + e.nodeName + ">")
            ? (a = e.cloneNode(!0))
            : ((tn.innerHTML = e.outerHTML), tn.removeChild((a = tn.firstChild))),
          !(
      ...
      clean: function(e, t, n, r) {
        var i,
          ...
          v = [];
        for (
          (t && "undefined" != typeof t.createDocumentFragment) || (t = P), o = t === P && en;
          null != (a = e[y]);
          y++
        )
            ...
            if ("string" == typeof a)
              if (Xt.test(a)) {
                ...
                !K.support.leadingWhitespace &&
                  Pt.test(a) &&
                  f.insertBefore(t.createTextNode(Pt.exec(a)[0]), f.firstChild),
                  (a = f.childNodes),
                  (f = o.lastChild);
        ...
        if ((f && (o.removeChild(f), (a = f = o = null)), !K.support.appendChecked))
          for (y = 0; null != (a = v[y]); y++)
            K.nodeName(a, "input")
              ? g(a)
              : "undefined" != typeof a.getElementsByTagName && K.grep(a.getElementsByTagName("input"), g);
        if (n)
          for (
            h = function(e) {
              return !e.type || Qt.test(e.type)
                ? r ? r.push(e.parentNode ? e.parentNode.removeChild(e) : e) : n.appendChild(e)
                : void 0;
            },
              y = 0;
            null != (a = v[y]);
      ...
      cleanData: function(e, t) {
        for (
          var n, r, i, o, a = 0, s = K.expando, u = K.cache, l = K.support.deleteExpando, c = K.event.special;
          null != (i = e[a]);
          a++
        )
  ...
  var nn,
    ...
    gn = { letterSpacing: 0, fontWeight: 400, lineHeight: 1 },
  ...
  K.fn.extend({
    ...
    K.extend({
      ...
      style: function(e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            u = K.camelCase(n),
            l = e.style;
          if (((n = K.cssProps[u] || (K.cssProps[u] = m(l, u))), (s = K.cssHooks[n] || K.cssHooks[u]), r === t))
            return s && "get" in s && (o = s.get(e, !1, i)) !== t ? o : l[n];
          if (
            ((a = typeof r),
            "string" === a && (o = pn.exec(r)) && ((r = (o[1] + 1) * o[2] + parseFloat(K.css(e, n))), (a = "number")),
            !(
              null == r ||
              ("number" === a && isNaN(r)) ||
              ("number" === a && !K.cssNumber[u] && (r += "px"), s && "set" in s && (r = s.set(e, r, i)) === t)
            ))
          )
            try {
              l[n] = r;
      ...
      css: function(e, n, r, i) {
        var o,
          ...
          u = K.camelCase(n);
        return (
          (n = K.cssProps[u] || (K.cssProps[u] = m(e.style, u))),
          (s = K.cssHooks[n] || K.cssHooks[u]),
    ...
    K.each(["height", "width"], function(e, t) {
      K.cssHooks[t] = {
        get: function(e, n, r) {
          return n
            ? 0 !== e.offsetWidth || "none" !== nn(e, "display")
              ? w(e, t, r)
              : K.swap(e, hn, function() {
                  return w(e, t, r);
                })
            : void 0;
        },
    ...
    K.expr &&
      ...
      ((K.expr.filters.hidden = function(e) {
        return (
          ...
          (!K.support.reliableHiddenOffsets && "none" === ((e.style && e.style.display) || nn(e, "display")))
        );
      }),
  ...
  K.fn.extend({
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        .filter(function() {
          return this.name && !this.disabled && (this.checked || Nn.test(this.nodeName) || Tn.test(this.type));
        })
        .map(function(e, t) {
          var n = K(this).val();
          return null == n
  ...
  try {
    ...
    (Cn = P.createElement("a")), (Cn.href = ""), (Cn = Cn.href);
  }
  (kn = _n.exec(Cn.toLowerCase()) || []),
    (K.fn.load = function(e, n, r) {
      ...
      return (
        ...
        K.isFunction(n) ? ((r = n), (n = t)) : "object" == typeof n && (o = "POST"),
        K.ajax({
          url: e,
          type: o,
          dataType: "html",
          ...
          (a = arguments), s.html(i ? K("<div>").append(e.replace($n, "")).find(i) : e);
        }),
        this
      );
    }),
    ...
    K.extend({
      ...
      ajax: function(e, n) {
          ...
          2 !== x &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (p.ifModified &&
                ...
                304 === e
                  ? ((N = "notmodified"), (l = !0))
                  : ((l = A(p, b)), (N = l.state), (f = l.data), (v = l.error), (l = !v)))
              : ((v = N), (!N || e) && ((N = "error"), 0 > e && (e = 0))),
            (T.status = e),
            (T.statusText = "" + (n || N)),
            ...
            m.fireWith(d, [T, N]),
            c && (h.trigger("ajaxComplete", [T, p]), --K.active || K.event.trigger("ajaxStop")));
        }
        ...
        if (
          ...
          (p.url = ((e || p.url) + "").replace(En, "").replace(Dn, kn[1] + "//")),
          (p.dataTypes = K.trim(p.dataType || "*").toLowerCase().split(tt)),
          null == p.crossDomain &&
            ((l = _n.exec(p.url.toLowerCase())),
            (p.crossDomain = !(
              !l ||
              (l[1] == kn[1] &&
                l[2] == kn[2] &&
                (l[3] || ("http:" === l[1] ? 80 : 443)) == (kn[3] || ("http:" === kn[1] ? 80 : 443)))
            ))),
        ...
        if (
          ...
          !p.hasContent &&
            (p.data && ((p.url += (Ln.test(p.url) ? "&" : "?") + p.data), delete p.data), (i = p.url), p.cache === !1))
        ) {
          var N = K.now(),
            C = p.url.replace(Hn, "$1_=" + N);
          p.url = C + (C === p.url ? (Ln.test(p.url) ? "&" : "?") + "_=" + N : "");
        }
        ((p.data && p.hasContent && p.contentType !== !1) || n.contentType) &&
          ...
          T.setRequestHeader(
            ...
            p.dataTypes[0] && p.accepts[p.dataTypes[0]]
              ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + qn + "; q=0.01" : "")
              : p.accepts["*"],
          );
    ...
    K.ajaxPrefilter("json jsonp", function(n, r, i) {
      var o,
        ...
        p =
          ...
          Wn.test(u);
      return "jsonp" === n.dataTypes[0] || f || p
        ? ((o = n.jsonpCallback = K.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
          (a = e[o]),
          f
            ? (n.url = l.replace(Wn, "$1" + o))
            : p ? (n.data = u.replace(Wn, "$1" + o)) : c && (n.url += (Pn.test(l) ? "&" : "?") + n.jsonp + "=" + o),
          ...
          i.always(function() {
            (e[o] = a),
              n[o] && ((n.jsonpCallback = r.jsonpCallback), In.push(o)),
          ...
          send: function(i, o) {
            (n = P.createElement("script")),
              ...
              (n.onload = n.onreadystatechange = function(e, i) {
                (i || !n.readyState || /loaded|complete/.test(n.readyState)) &&
            ...
            send: function(i, o) {
              ...
              u.send((n.hasContent && n.data) || null),
                (r = function(e, i) {
                  ...
                  try {
                    if (r && (i || 4 === u.readyState))
                      if (((r = t), a && ((u.onreadystatechange = K.noop), Xn && delete zn[a]), i))
                ...
                n.async
                  ? 4 === u.readyState
                    ? setTimeout(r, 0)
                    : ((a = ++Un), Xn && (zn || ((zn = {}), K(e).unload(Xn)), (zn[a] = r)), (u.onreadystatechange = r))
                  : r();
            },
            abort: function() {
              r && r(0, 1);
        ...
        function(e, t) {
          ...
          if (a) {
            if (((n = +a[2]), (r = a[3] || (K.cssNumber[e] ? "" : "px")), "px" !== r && u)) {
              ...
              do (i = l = l || ".5"), (u /= l), K.style(o.elem, e, u + r), (l = o.cur() / s);
              while (1 !== l && l !== i);
            }
  ...
  (K.Animation = K.extend(H, {
    ...
    (M.propHooks = {
      _default: {
        ...
        set: function(e) {
          K.fx.step[e.prop]
            ? K.fx.step[e.prop](e)
            : e.elem.style && (null != e.elem.style[K.cssProps[e.prop]] || K.cssHooks[e.prop])
    ...
    K.each(["toggle", "show", "hide"], function(e, t) {
      ...
      K.fn[t] = function(r, i, o) {
        return null == r || "boolean" == typeof r || (!e && K.isFunction(r) && K.isFunction(i))
          ? n.apply(this, arguments)
          : this.animate(O(t, !0), r, i, o);
      };
    }),
    K.fn.extend({
      ...
      stop: function(e, n, r) {
        ...
        return (
          ...
          this.each(function() {
            ...
            else for (n in a) a[n] && a[n].stop && Qn.test(n) && i(a[n]);
            for (n = o.length; n--; )
      ...
      return (
        (r.duration = K.fx.off
          ...
          : "number" == typeof r.duration
            ? r.duration
            : r.duration in K.fx.speeds ? K.fx.speeds[r.duration] : K.fx.speeds._default),
  ...
  (K.fn.offset = function(e) {
        ...
        : ((r = d.documentElement),
          K.contains(r, p)
            ? ((n = p.getBoundingClientRect()),
              ...
              (u = o.pageYOffset || r.scrollTop),
              (l = o.pageXOffset || r.scrollLeft),
              (c = n.top + u - a),
              (f = n.left + l - s),
              { top: c, left: f })
            : { top: 0, left: 0 });
      ...
      bodyOffset: function(e) {
        ...
        return (
          K.support.doesNotIncludeMarginInBodyOffset &&
            ((t += parseFloat(K.css(e, "marginTop")) || 0), (n += parseFloat(K.css(e, "marginLeft")) || 0)),
          { top: t, left: n }
        );
      },
    ...
    K.fn.extend({
      ...
      offsetParent: function() {
        return this.map(function() {
          for (var e = this.offsetParent || P.body; e && !er.test(e.nodeName) && "static" === K.css(e, "position"); )
            e = e.offsetParent;
          return e || P.body;
        });
      },
        ...
        return K.access(
          ...
          function(e, i, o) {
            ...
            return o === t
              ...
              : void (a ? a.scrollTo(r ? K(a).scrollLeft() : o, r ? o : K(a).scrollTop()) : (e[i] = o));
          },
          e,
          i,
          arguments.length,
            ...
            function(n, r, i) {
              ...
              return K.isWindow(n)
                ...
                : 9 === n.nodeType
                  ...
                  : i === t ? K.css(n, r, i, s) : K.style(n, r, i, s);
            },
            n,
            a ? i : t,
            a,
 ...
 */,
  (function(e, t) {
        ...
        o !== l
          ? ((c = i.match(t ? /^([^#]*)\#?(.*)$/ : /^([^#?]*)\??([^#]*)(#?.*)/)),
            ...
            2 === a && n(o)
              ...
              : ((p = f(c[2])),
                (o = n(o) ? f[t ? N : T](o) : o),
                (u = 2 === a ? o : 1 === a ? e.extend({}, o, p) : e.extend({}, p, o)),
                (u = b(u))),
            (s = c[1] + (t ? "#" : u || !c[1] ? "?" : "") + u + d))
          : (s = r(i !== l ? i : m[k])),
        s
    ...
    function s(e, t, r) {
      return (
        t === l || "boolean" == typeof t ? ((r = t), (t = b[e ? N : T]())) : (t = n(t) ? t.replace(e ? L : D, "") : t),
        f(t, r)
      );
    }
    function u(t, r, i, o) {
      return (
        n(i) || "object" == typeof i || ((o = i), (i = r), (r = l)),
        this.each(function() {
          var n = e(this),
            a = r || h()[(this.nodeName || "").toLowerCase()] || "",
            s = (a && n.attr(a)) || "";
          n.attr(a, b[t](s, i, o));
        })
      );
    ...
    (b[T] = r(a, 0, o)),
      (b[N] = c = r(a, 1, i)),
      (e.deparam = f = function(t, n) {
        var r = {},
          i = { true: !0, false: !1, null: null };
        return (
          e.each(t.replace(/\+/g, " ").split("&"), function(t, o) {
            var a,
              s = o.split("="),
              u = v(s[0]),
              c = r,
            ...
            if (
              (/\[/.test(p[0]) && /\]$/.test(p[d])
                ? ((p[d] = p[d].replace(/\]$/, "")), (p = p.shift().split("[").concat(p)), (d = p.length - 1))
                : (d = 0),
              2 === s.length)
            )
              if (((a = v(s[1])), n && (a = a && !isNaN(a) ? +a : "undefined" === a ? l : i[a] !== l ? i[a] : a), d))
                for (; d >= f; f++)
                  (u = "" === p[f] ? c.length : p[f]),
                    (c = c[u] = d > f ? c[u] || (p[f + 1] && isNaN(p[f + 1]) ? {} : []) : a);
              else e.isArray(r[u]) ? r[u].push(a) : (r[u] = r[u] !== l ? [r[u], a] : a);
            else u && (r[u] = n ? l : "");
          }),
          r
        );
      ...
      e[C] ||
        (e[C] = function(t) {
          return e.extend($, t);
        })({ a: k, base: k, iframe: E, img: E, input: E, form: "action", link: k, script: E }),
      (h = e[C]),
      (e.fn[T] = r(u, T)),
      (e.fn[N] = r(u, N)),
      (x.pushState = d = function(e, t) {
        n(e) && /^#/.test(e) && t === l && (t = 2);
        var r = e !== l,
          i = c(m[k], r ? e : {}, r ? t : 2);
        m[k] = i + (/#/.test(i) ? "" : "#");
      }),
      (x.getState = function(e, t) {
        return e === l || "boolean" == typeof e ? p(e) : p(t)[e];
      }),
      (x.pollDelay = 100),
      (e.event.special[w] = {
        setup: function() {
          return j ? !1 : void g.start();
        },
        teardown: function() {
          return j ? !1 : void g.stop();
        },
        add: function(e) {
          return function(t) {
            var n = (t[N] = c());
            (t.getState = function(e, t) {
              return e === l || "boolean" == typeof e ? f(n, e) : f(n, t)[e];
            }),
      ...
      (g = (function() {
        function n() {
          (a = s = function(e) {
            ...
            A &&
              ((o = e('<iframe src="javascript:0"/>').hide().appendTo("body")[0].contentWindow),
              (s = function() {
                return i(o.document.location[k]);
              }),
              (a = function(e, t) {
                if (e !== t) {
                  var n = o.document;
                  n.open().close(), (n.location.hash = "#" + e);
                }
              })(c()));
        }
        var r,
            ...
            if (!r) {
              ...
              a || n(),
                (function o() {
                  var n = c(),
                    u = s(i);
                  n !== i ? (a((i = n), u), e(t).trigger(w)) : u !== i && d("#" + u), (r = setTimeout(o, x.pollDelay));
                })();
            }
          }),
          (u.stop = function() {
            o || (r && clearTimeout(r), (r = 0));
          }),
          u
        );
      })());
  ...
  function() {
    ...
    (t = 0),
      (e = 3e4),
      $(function() {
        return $(".autoscroll").animate({ scrollLeft: e }, t, "swing", function() {
          return $("#time-panel .line").fadeIn();
        });
      });
  }.call(this),
  function() {
    ...
    $(document).ready(function() {
      ...
      (e = {
        ...
        prepare: function() {
          ...
          return (
            (t = $("#text_flow").height()),
            (e.max = $("#main_text").height()),
            (e.btnDown = $("#scroll_down")),
            (e.btnUp = $("#scroll_up")),
            t > e.max
              ? ((e.max -= 20),
                e.btnDown.show(),
                $("#main_text").animate({ scrollTop: 0 }, 0),
        ...
        scroll: function(t) {
          ...
          return (
            e.btnDown.hide(),
            e.btnUp.hide(),
            (n = $("#main_text").offset().top - $("#text_flow").offset().top),
            (n += t * e.max),
            0 > n && (n = 0),
            $("#main_text").animate({ scrollTop: n }, 2e3, "swing", function() {
              var t;
              return (
                n > 0 && e.btnUp.show(),
                (t = $("#main_text").offset().top - $("#text_flow").offset().top),
                t === n ? e.btnDown.show() : void 0
              );
            })
          );
        },
    ...
    (e = -1),
      ...
      $(function() {
        ...
        return (
          ...
          (i = $("#slides .slide").size()),
          n(t()),
          $("#slideFirst").click(function() {
            return n(1);
          }),
          $("#slideLast").click(function() {
            return n(i);
          }),
          $("#slidePrev").click(function() {
            return e > 1 ? n(e - 1) : void 0;
          }),
          $("#slideNext").click(function() {
            return i > e ? n(e + 1) : void 0;
          })
        );
      }),
      (t = function() {
        var e;
        return (e = $.param.fragment()), e.match(/^\/imagen=\d+/) ? parseInt(e.substring(8)) : 1;
      }),
      (n = function(t) {
        var n, i, o, a;
        if (t !== e)
          return (
            $("#showImage" + e).removeClass("selected"),
            $("#slideImage" + e).hide(),
            r.hide(),
            (e = t),
            (i = $("#slideImage" + t)),
            ...
            r.css("margin-left", o),
            i.fadeIn("slow"),
            $("#number_control").text(t),
            r.fadeIn("slow"),
            $("#showImage" + t).addClass("selected"),
            !1
          );
      });
  }.call(this),
  function() {
    var activateTag, showActiveProjects, tagToCardIDs;
    (tagToCardIDs = {}),
      (activateTag = function(e) {
        ...
        return (
          ...
          (t = n.hasClass("active") ? n.css("color") : "white"),
          n.css("background-color", t)
        );
      }),
      (showActiveProjects = function() {
        var e;
        return (
          (e = $("#tags .active")),
          0 === e.length
            ...
            : ($("#grid .card").addClass("hide"),
              $.each(e, function() {
                var e, t;
                return (
                  (t = $(this).attr("id").substring(4)),
                  (e = tagToCardIDs[t]),
                  $.each(e, function() {
                    return $(".card" + this).removeClass("hide").fadeIn();
                  })
                );
              }),
      ...
      $(function() {
        return (
          ...
          $("#tags .tag-link").click(function() {
            var e;
            return (e = $(this).attr("id").substring(4)), activateTag(e), showActiveProjects();
          })
        );
      });
  }.call(this),
  function() {
    ...
    (e = []),
      ...
      (a = function(e, n) {
        ...
        if (t === e)
          return (
            (o = parseInt(n.css("left")) + 12),
            (a = parseInt(n.css("top")) - 3),
            a > 240 && (a -= i.height() - 13),
            i.css("left", o),
            i.css("top", a),
            i.show(),
            (r = $("#preview_image").width()),
            $(".mini_text").width(r)
          );
      }),
      (n = function() {
        return (t = null), i.hide();
      }),
      (r = function(t, n) {
        return e[t]
          ? (i.html(e[t]), n())
      ...
      (o = function(e, t) {
        ...
        return (
          (n = e.split("-")[1]),
          i.load("/thumb/" + n, function(e, n) {
            return "success" === n ? t(e) : void 0;
          })
        );
      }),
      $(function() {
